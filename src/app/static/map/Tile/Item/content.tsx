...
const TEXT_CLASSES = "max-w-[90%] break-words text-neutral-900 dark:text-neutral-100";
...
const DescriptionSection = (description: string, scale: TileScale) => {
  ...
  return (
    <div className={`mt-1 ${textSize} ${TEXT_CLASSES} prose ${proseSize} prose-neutral max-w-full`}>
      <ReactMarkdown
        components={{
