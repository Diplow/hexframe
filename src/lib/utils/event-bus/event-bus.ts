import type { AppEvent, EventListener, EventBusService } from '~/lib/utils/event-bus/types';
 ...
 *
 * IMPORTANT: Use this singleton for client-side code to ensure all components
 * share the same event bus. Server-side code should create its own instances
 * as needed for request-scoped event handling.
 */
